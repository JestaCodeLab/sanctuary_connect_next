...
const plans: PlanDetails[] = [
  {
    ...
    features: [
      ...
      { text: 'Single branch', included: true },
      { text: 'Member directory', included: true },
      { text: 'Group management', included: true },
      { text: 'Annual Calendar', included: true },
      { text: 'Email notifications', included: true },
      { text: 'Online giving & donations (20 transactions/month)', included: true },
      { text: 'Attendance tracking', included: false },
      { text: 'AI "Shepherd" alerts', included: false },
      { text: 'SMS credits', included: false },
    ],
  },
  {
    id: 'growth',
    ...
    features: [
      ...
      { text: 'Single branch', included: true },
      { text: 'All Seed Plan features', included: true },
      { text: 'Attendance tracking', included: true },
      { text: 'AI "Shepherd" alerts', included: true },
      { text: 'Monthly 100 SMS credits', included: true },
      { text: 'Online giving & donations (50 transactions/month)', included: true },
      { text: 'Group dues module', included: true },
      { text: 'Member engagement vault', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Monthly 250 SMS credits', included: true },
      { text: 'Advanced Financial reporting', included: true },
      ...
      { text: 'Online giving & donations (unlimited)', included: true },
    ],
  },
];
